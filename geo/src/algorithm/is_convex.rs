...
mod hegel_props {
    use super::IsConvex;
    use crate::utils::hegel_gens::{canonical_ring, convex_polygons, grid_point_sets, star_rings};
    ...
    // differing arithmetic cannot diverge through rounding. Neither promises
    // a particular start vertex, hence `canonical_ring`.
    #[hegel::test]
